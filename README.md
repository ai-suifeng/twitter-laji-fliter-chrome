...
| OpenRouter | `openrouter.ai/api/alpha/decisions` · `~typesafe/jev-latest` | 可用（[模型页](https://openrouter.ai/~typesafe/jev-latest)：$0.042/M 输入、输出免费、32k 上下文）。注意模型名带波浪号，key 为 `sk-or-v1-` 前缀，与 TypeSafe 官方的 `apikey_` 前缀不通用 |
